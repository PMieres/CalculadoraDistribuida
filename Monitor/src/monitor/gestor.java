									...
									if(conectado) { //Si se logro inicializar el monitor
										...
										switch(action) {
											...
											case "Suma":{
												...
												try {
													 byte[] bytesSuma = Files.readAllBytes(Paths.get("C:/Users/Mieres/Desktop/Calculadora/Operaciones/Suma.jar"));
											...
											case "Resta":{
												...
												try {
													byte[] bytesResta = Files.readAllBytes(Paths.get("C:/Users/Mieres/Desktop/Calculadora/Operaciones/Resta.jar"));
											...
											case "Multiplicacion":{
												...
												try {
													byte[] bytesMulti = Files.readAllBytes(Paths.get("C:/Users/Mieres/Desktop/Calculadora/Operaciones/Multiplicacion.jar"));
											...
											case "Division":{
												...
												try {
													byte[] bytesDiv = Files.readAllBytes(Paths.get("C:/Users/Mieres/Desktop/Calculadora/Operaciones/Division.jar"));
